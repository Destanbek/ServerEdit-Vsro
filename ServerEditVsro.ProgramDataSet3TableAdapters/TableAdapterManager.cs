...
namespace ServerEditVsro.ProgramDataSet3TableAdapters
{
	...
	public class TableAdapterManager : Component
	{
		...
		private Sponsor4TableAdapter _sponsor4TableAdapter;
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[DebuggerNonUserCode]
		public Sponsor4TableAdapter Sponsor4TableAdapter
		{
			get
			{
				return _sponsor4TableAdapter;
			}
			set
			{
				_sponsor4TableAdapter = value;
			}
		}
		...
		public IDbConnection Connection
		{
			get
			{
				...
				if (_sponsor4TableAdapter != null && _sponsor4TableAdapter.Connection != null)
				{
					return _sponsor4TableAdapter.Connection;
				}
				return null;
			}
			set
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[DebuggerNonUserCode]
		private int UpdateUpdatedRows(ProgramDataSet3 dataSet, List<DataRow> allChangedRows, List<DataRow> allAddedRows)
		{
			int num = 0;
			if (_sponsor4TableAdapter != null)
			{
				DataRow[] realUpdatedRows = GetRealUpdatedRows(dataSet.Sponsor4.Select(null, null, DataViewRowState.ModifiedCurrent), allAddedRows);
				if (realUpdatedRows != null && realUpdatedRows.Length != 0)
				{
					num += _sponsor4TableAdapter.Update(realUpdatedRows);
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		private int UpdateInsertedRows(ProgramDataSet3 dataSet, List<DataRow> allAddedRows)
		{
			int num = 0;
			if (_sponsor4TableAdapter != null)
			{
				DataRow[] array = dataSet.Sponsor4.Select(null, null, DataViewRowState.Added);
				if (array != null && array.Length != 0)
				{
					num += _sponsor4TableAdapter.Update(array);
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[DebuggerNonUserCode]
		private int UpdateDeletedRows(ProgramDataSet3 dataSet, List<DataRow> allChangedRows)
		{
			int num = 0;
			if (_sponsor4TableAdapter != null)
			{
				DataRow[] array = dataSet.Sponsor4.Select(null, null, DataViewRowState.Deleted);
				if (array != null && array.Length != 0)
				{
					num += _sponsor4TableAdapter.Update(array);
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		public virtual int UpdateAll(ProgramDataSet3 dataSet)
		{
			if (dataSet == null)
			{
			...
			if (_sponsor4TableAdapter != null && !MatchTableAdapterConnection(_sponsor4TableAdapter.Connection))
			{
			...
			try
			{
				if (_sponsor4TableAdapter != null)
				{
					dictionary.Add(_sponsor4TableAdapter, _sponsor4TableAdapter.Connection);
					_sponsor4TableAdapter.Connection = (SqlConnection)connection;
					_sponsor4TableAdapter.Transaction = (SqlTransaction)dbTransaction;
					if (_sponsor4TableAdapter.Adapter.AcceptChangesDuringUpdate)
					{
						_sponsor4TableAdapter.Adapter.AcceptChangesDuringUpdate = false;
						list3.Add(_sponsor4TableAdapter.Adapter);
					}
				}
			...
			finally
			{
				...
				if (_sponsor4TableAdapter != null)
				{
					_sponsor4TableAdapter.Connection = (SqlConnection)dictionary[_sponsor4TableAdapter];
					_sponsor4TableAdapter.Transaction = null;
				}
				if (0 < list3.Count)
				{

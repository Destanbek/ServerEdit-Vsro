...
namespace ServerEditVsro
{
	public class Adminlogin : Form
	{
		...
		{
			if (textBox1.Text == "destanbek" && textBox2.Text == "postakodu34000@gmail.com" && textBox3.Text == "12345")
			{
				Hide();
				new adminpanel().Show();
			}
			else
			{
                ...
                {
                    MessageBox.Show("You Did Wrong Operation Or You Entered Wrong User Name E-Mail Password Please Try Again.");
                }
                else
                {
                    MessageBox.Show("Yanlış İşlem Yaptınız Veya Yalnış Kullanıcı Adı E-Posta Şifre Girdiniz Lütfen Yeniden Deneyiniz.");
                }
            }
		}
		...
		private void InitializeComponent()
		{
            ...
            // button1
            // 
            this.button1.Image = global::ServerEditVsro.Properties.Resources.login_icon_png_27;
